describe('Produstos POST', () => {
    /*
        Neste arquivo executa apenas os testes, sem as depências criadas.
    */
    beforeEach(() => {
        /* 
            Carrega os dados do arquivo produtos.json, mensagens.json, usuarios.json
            que contém os dados do produto a ser criado, mensagens esperadas e token do usuario.
        */
    ...
    */
    it('Cadastrar um produto com sucesso', function () {
        ...
        return cy.criarProduto(paramsCriarProduto).then((res) => {
            ...
            this.produtosFixture.produtoCorretoParaSemDepencia.id = res.body._id;
            return cy.writeFile('cypress/fixtures/produtos.json', this.produtosFixture);
        });
    });
